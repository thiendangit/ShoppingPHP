                ...
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{!! getConfigValueFromSettingTable('inlink_link') !!}"><i class="fa fa-linkedin"></i></a></li>
                            <li><a href="{!! getConfigValueFromSettingTable('instagram_link') !!}"><i class="fa fa-dribbble"></i></a></li>
                            <li><a href="{!! getConfigValueFromSettingTable('google_link') !!}"><i class="fa fa-google-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                   ...
                   @include('shop.home.components.main_menu')
                </div>
                <div class="col-sm-3">
